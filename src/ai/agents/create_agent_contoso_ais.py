...
AGENT_INSTRUCTIONS = (
    "You are a helpful AI Search Assistant for Contoso Products. Use the file search tool to find "
    "and provide information about Contoso products and services. Always use the search tool to "
    "find relevant information before responding."
)
...
def main():
    ...
    try:
        ...
        vector_store = client.agents.vector_stores.create_and_poll(file_ids=file_ids, name="contoso_ais_vectorstore")
