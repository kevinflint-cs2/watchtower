...
## Goals
- Deploy ChatGPT 4o Mini LLM in Azure Foundry Project
...
## Roadmap (high level)
- Now: Deploy ChatGPT 4o Mini LLM in Azure Foundry
- Next: Create an AI Agent to interact with LLM model
- Later: Add file to AI Agent to give additional contextual data for grounding